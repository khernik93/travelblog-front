...
import { GetPosts, ClearPosts } from '../../../../src/modules/content/components/postsList/store/postsList.actions';
...
describe('PostsListComponent', () => {
  ...
  `, () => {
    ...
    expect(store.dispatch.calls.first().args).toEqual([new ClearPosts()]);
    expect(store.dispatch.calls.mostRecent().args).toEqual([new GetPosts(
      INITIALLY_SELECTED_TAB,
      postsListService.DEFAULT_START,
      postsListService.DEFAULT_END
    )]);
  });
